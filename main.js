...
async function main() {
	...
	const answer = await inquirer.prompt({
		...
		choices: [
			...
			{name: 'Disable Fast Startup', value: 'disableFastStartup', checked: true},
			{name: 'Remove Duplicate Drive Entries in Navigation Pane', value: 'removeDuplicateDrives', checked: true},
			{name: 'Disable Gallery in File Explorer', value: 'disableGallery', checked: true},
			...
			{name: 'Remove "Cast to Device"', value: 'explorerDisableCtxCastToDevice', checked: true},
